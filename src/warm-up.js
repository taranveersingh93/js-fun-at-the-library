...
pages = pages/4;
//console.log(`quarter pages ${pages}`);


// Initialize a new variable "movie", but leave it undefined
var movie;
//console.log(`undefined movie ${movie}`);
...
//console.log(`short story should be false ${isShortStory}`);
//------------------------- Conditionals -------------------------//
...
var books = ["Alpha", "Bravo", "Charlie", "Delta", "Echo"];
...
var belowTwoHundred = [10,20,30,40,50,60,70,81,92,102,114, 129];
